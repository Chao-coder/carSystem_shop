...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
            <span class="mdl-layout-title">personal informations</span>
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            ...
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/information"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>personal infor</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/list"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>order-manage</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/address"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">local_offer</i>address-manage</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/favorite"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">flag</i>my collection</a>
        </nav>
    </div>
            ...
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tbody >
                            <tr >
                                <th style="border: 0px solid transparent" class="tl">id-user</th>
                                <td style="border: 0px solid transparent" class="tr" id="userIdVal">${user.getUserid()}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">name-user</th>
                                <td style="border: 0px solid transparent" class="tr" id="nameVal">${user.getUsername()}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">registration time</th>
                ...
                <div class="mdl-card__actions mdl-card--border">
                    <button class="templatemo-blue-button" id="changeInfo"><h5>modify infomation</h5></button>
