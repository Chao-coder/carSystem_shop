            ...
            <div class="sort">
                <div class="sort-channel">
                    <ul class="sort-channel-list list-group">
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Geely">Geely</a>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Benz">Benz</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=BMW">BMW</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Toyota">Toyota</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Tesla">Tesla</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Porsche">Porsche</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Ford">Ford</a>
                            <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
