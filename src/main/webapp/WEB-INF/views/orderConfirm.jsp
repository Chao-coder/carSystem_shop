...
<div class="shopping_cart">
    <div class="container">
        ...
        <%--商品信息--%>
        <h4 class="header-border h4-mar-2">confirm receipt car</h4>
        <div class="row">
                    ...
                    <div class="wishlist-content wishlist-content-2">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-12 form-group form-group-lg">
                                <label class="col-sm-2 control-label" for="pay-select">select way-of-pay</label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="pay-select">
                                        <option value="1">online-pay</option>
                                        <option value="0">receive-pay</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="cart_totals">
                                    ...
                                    <div class="wc-proceed-to-checkout">
                                        ...
                                        <button id="confirm-orders"
                                                class="button_act button_act-tc confirm-orders pull-right">settlement
                                        </button>
                                    </div>
                                </div>
                            </div>
