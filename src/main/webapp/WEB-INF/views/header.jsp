    ...
    <div class="col-md-4" role="navigation">
        ...
        <ul class="nav nav-pills">
            <c:if test="${empty sessionScope.user}">
                <li><a href="${pageContext.request.contextPath}/login" style="color: #F22E00">please sign in</a></li>
            </c:if>
            <c:if test="${!empty sessionScope.user}">
                <li class="info-a">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/information">account mangement</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${pageContext.request.contextPath}/logout" class="login-out">sign out</a></li>
                    </ul>
                </li>
            </c:if>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    <li><a class="a-color" href="${pageContext.request.contextPath}/main">first-page</a></li>
                    ...
                    <li class="dropdown"><a class="a-color" href="${pageContext.request.contextPath}/info/list"
                            ...
                            class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="${pageContext.request.contextPath}/info/address">address-mangment</a></li>
                            <li><a href="${pageContext.request.contextPath}/order">交易中</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/chatrobot">small-c</a></li>
                        </ul></li>
                </ul>
